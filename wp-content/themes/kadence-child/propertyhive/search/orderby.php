...
<?php
	if ( isset($_GET['view']) && $_GET['view'] != '' ) {
		if( $_GET['view'] == 'map' ) {
			$view_active_class = 'map-view-active';
		} else {
			$view_active_class = 'grid-view-active';
		}
	} else {
		$view_active_class = ' grid-view-active ';
	}
?>
	<div class="cw-order-views-wrapper <?php echo $view_active_class; ?>">
		...
		<div class="cw-search-views">
			<a class="cw-search-views-grid" href="<?php echo get_home_url(); ?>/properties/">Grid View</a>
			<a class="cw-search-views-map" href="<?php echo get_home_url(); ?>/properties/?view=map">Map View</a>
		</div>
	</div>
</div>