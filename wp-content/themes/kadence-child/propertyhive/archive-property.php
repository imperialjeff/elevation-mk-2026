                                                        ...
                                                        if ( isset($_GET['view']) && $_GET['view'] != '' ) {
                                                            if( $_GET['view'] == 'map' ) { ?>
                                                                addLocratingMapMarker('properties_map',{
                                                                    ...
                                                                    icon: '<?php echo get_site_url(); ?>/wp-content/uploads/2023/03/map-marker-icon-default.png',
                                                                    clickedIcon: '<?php echo get_site_url(); ?>/wp-content/uploads/2023/03/map-marker-icon-active.png',
                                                                    iconHeight: 50,
                                                                    iconHeight: 35,
                                                                });
                                                            <?php } else {
