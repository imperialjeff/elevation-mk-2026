...
= 2.0.2 =
* Turn results page into a template so it can be overwritten to the theme and customised
* Declared support for WordPress 6.8.3

= 2.0.1 =
* Added support for map provider and geocoding provider being OSM
