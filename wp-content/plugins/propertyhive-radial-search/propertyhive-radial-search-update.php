...
/*
*  properthive_radial_search_update
*
...
class properthive_radial_search_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'https://wp-property-hive.com/add-on-store/propertyhive-radial-search-av12cc9lo/update-info.php',
		...
		if ( apply_filters( 'propertyhive_add_on_can_be_updated', false, 'propertyhive-radial-search' ) === true )
	    {
...
if( is_admin() )
{
	new properthive_radial_search_update();
}
