...
/*
*  propertyhive_property_import_update
*
...
class propertyhive_property_import_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'https://wp-property-hive.com/add-on-store/propertyhive-property-import-c350alqg/update-info.php',
		...
		if ( apply_filters( 'propertyhive_add_on_can_be_updated', false, 'propertyhive-property-import' ) === true )
	    {
...
if( is_admin() )
{
	new propertyhive_property_import_update();
}
